...
\graphicspath{{../figures/}{../results/}{../results/elliptic/}}
...
Future work: Hamilton-Jacobi viability kernels for exact safe-set computation, multi-phase approach strategies, 3D tumble with full Euler dynamics, and navigation uncertainty integration.
