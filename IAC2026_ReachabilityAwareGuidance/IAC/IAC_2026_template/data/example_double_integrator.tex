...
The backward reachable sets (safe-start regions) for $N=5$ steps to a target set near the origin are computed under three assumptions:
\begin{itemize}
...
%% Figure commented out: overlay_comparison.pdf not yet generated
%\begin{figure}[H]
%\centering
